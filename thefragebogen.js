...
function QuestionnaireItemQuality7pt(className, question, required, labels) {
	...
	if (arguments.length < 4)
	{
		this.caption10 = "extrem schlecht";
		this.caption20 = "sehr schlecht";
		this.caption30 = "eher schlecht";
		this.caption40 = "unentschieden";
		this.caption50 = "eher gut";
		this.caption60 = "sehr gut";
